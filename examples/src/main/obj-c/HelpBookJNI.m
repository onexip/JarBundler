/*
**    JNI hook for invoking "NSApplication showHelp:"
**
...
JNIEXPORT void JNICALL Java_com_ultramixer_jarbundler_example_HelpBook_launchHelpViewer (JNIEnv *env, jclass clazz) {
